...
class Qwen3MoeDecoderLayer: Module {
    ...
    func callThrowing(
        ...
        var r = try selfAttn.callThrowing(inputLayerNorm(x), mask: mask, cache: cache)
        let h = x + r
...
public class Qwen3MoEModel: Module, LLMModel, KVCacheDimensionProvider, ThrowingLanguageModel {
