...
private func melFilterBank(
    ...
    var filterBank = [[Float]](
        repeating: [Float](repeating: 0, count: numMelFilters), count: numFrequencyBins)
...
public class Gemma4AudioFeatureExtractor {
    ...
    public func extract(waveform: [Float]) -> (features: MLXArray, mask: MLXArray) {
        ...
        var frames = [[Float]](
            repeating: [Float](repeating: 0, count: frameLength), count: numFrames)
        ...
        var melSpectrogram = [[Float]](
            repeating: [Float](repeating: 0, count: featureSize), count: numFrames)
        ...
        for i in 0 ..< numFrames {
            ...
            realHalf.withUnsafeMutableBufferPointer { rBuf in
                imagHalf.withUnsafeMutableBufferPointer { iBuf in
                    ...
                    // vDSP_fft_zrip scales by 2x relative to numpy's rfft.
